...
var y2 = (0, import_react3.forwardRef)((o3, a3) => {
  ...
  (0, import_react3.useImperativeHandle)(a3, () => ({ wrapper: h.current, content: w.current, lenis: k2 }), [k2]), (0, import_react3.useEffect)(() => {
    ...
    p2 && k2 && d.setState({ lenis: k2, addCallback: C, removeCallback: E2 });
  }, [p2, k2, C, E2]);
  ...
  }), [k2, S]), import_react3.default.createElement(m.Provider, { value: { lenis: k2, addCallback: C, removeCallback: E2 } }, p2 ? f3 : import_react3.default.createElement("div", Object.assign({ ref: h, className: clsx_default(null == k2 ? void 0 : k2.className, O) }, g2), import_react3.default.createElement("div", { ref: w }, f3)));
});
export {
  y2 as Lenis,
  m as LenisContext,
